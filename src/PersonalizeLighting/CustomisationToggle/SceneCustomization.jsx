      ...
      <div className="rounded-3xl bg-gradient-to-r from-gray-100 to-stone-100 w-full h-auto flex flex-wrap justify-between px-6 py-5">
        ...
        <div className="p-4 mb-8 relative">
          <div
            ...
            style={{
              backgroundImage: `url('https://images.pexels.com/photos/708440/pexels-photo-708440.jpeg?auto=compress&cs=tinysrgb&w=600')`,
            }}
          ></div>
        ...
        <div className="p-4 mb-8 relative">
          <div
            className="absolute inset-0 bg-cover bg-center rounded-2xl"
            style={{
              backgroundImage: `url('https://images.pexels.com/photos/247314/pexels-photo-247314.jpeg?auto=compress&cs=tinysrgb&w=600')`,
            }}
          ></div>
        ...
        <div className="p-4 mb-8 relative">
          <div
            className="absolute inset-0 bg-cover bg-center rounded-2xl"
            style={{
              backgroundImage: `url('https://images.pexels.com/photos/214574/pexels-photo-214574.jpeg?auto=compress&cs=tinysrgb&w=600')`,
            }}
          ></div>
        ...
        <div className="p-4 mb-8 relative">
          <div
            className="absolute inset-0 bg-cover bg-center rounded-2xl"
            style={{
              backgroundImage: `url('https://images.pexels.com/photos/1105666/pexels-photo-1105666.jpeg?auto=compress&cs=tinysrgb&w=600')`,
            }}
          ></div>
